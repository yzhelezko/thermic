...
export class Modal {
    ...
    confirm(title, message, options = {}) {
        return this.show({
            title,
            message,
            icon: options.icon || '<img src="./icons/warning.svg" class="svg-icon" alt="⚠️">',
            buttons: [
    ...
    confirmDelete(itemName, itemType = 'item') {
        return this.confirm(
            ...
            {
                icon: '<img src="./icons/error.svg" class="svg-icon" alt="🗑️">',
                confirmText: 'Delete',
                danger: true
            }
        );
    ...
    info(title, message, options = {}) {
        return this.show({
            title,
            message,
            icon: options.icon || '<img src="./icons/info.svg" class="svg-icon" alt="ℹ️">',
            buttons: [
    ...
    error(title, message, options = {}) {
        return this.show({
            title,
            message,
            icon: options.icon || '<img src="./icons/error.svg" class="svg-icon" alt="❌">',
            buttons: [
    ...
    success(title, message, options = {}) {
        return this.show({
            title,
            message,
            icon: options.icon || '<img src="./icons/star.svg" class="svg-icon" alt="✅">',
            buttons: [
