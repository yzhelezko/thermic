...
export function createTabsTemplate() {
    ...
    const windowControlsHTML = isMacOS ? `
        ...
        <button class="window-control window-control-close" id="window-close" title="Close">
        ...
        <button class="window-control window-control-minimize" id="window-minimize" title="Minimize">
            <span class="window-control-icon">
                <svg width="6" height="6" viewBox="0 0 10 10" fill="currentColor">
        ...
        <button class="window-control window-control-maximize" id="window-maximize" title="Maximize">
            <span class="window-control-icon">
                <svg width="6" height="6" viewBox="0 0 10 10" fill="currentColor">
